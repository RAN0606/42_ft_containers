...
# diff  ft_result std_result 
# echo FT
# c++ -std=c++98 -Wall -Wextra -Werror -D TESTED_NAMESPACE=ft testmap.cpp testset.cpp testvector.cpp teststack.cpp  main.cpp -o FT_CONTAINER ;  time ./FT_CONTAINER > ft_result; rm FT_CONTAINER 
# echo 
# echo STD
# c++ -std=c++98 -Wall -Wextra -Werror -D TESTED_NAMESPACE=std testmap.cpp testset.cpp testvector.cpp teststack.cpp  main.cpp -o STD_CONTAINER ;  time ./STD_CONTAINER > std_result; rm STD_CONTAINER 